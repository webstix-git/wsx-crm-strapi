...
export interface ApiCompanyCompany extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Address: Attribute.Component<'address.address', true>;
    comapnyWebsite: Attribute.String;
    ...
    contacts: Attribute.Relation<
      ...
      'api::contact.contact'
    >;
    Partner: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiContactContact extends Schema.CollectionType {
  ...
  attributes: {
    ...
    contactType: Attribute.Enumeration<
      ['Primary', 'Secondary', 'IT Contact', 'Others']
    >;
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    serviceDescription: Attribute.Text;
    picture: Attribute.Media;
    price: Attribute.Decimal;
    billingFrequency: Attribute.Enumeration<
      ['One Time', 'Monthly', 'Quarterly', 'Half Yearly', 'Annually']
    >;
    blocksPurchased: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiWebsiteWebsite extends Schema.CollectionType {
  ...
  attributes: {
    ...
    company: Attribute.Relation<
      ...
      'api::company.company'
    >;
    agreement: Attribute.DynamicZone<
